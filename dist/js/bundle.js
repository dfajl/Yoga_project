...
function calculate() {
  ...
  totalValue.innerHTML = 0; // console.log(typeof(persons.value)); там сейчас лежит пустая строка
...
function form() {
  ...
  input = form.getElementsByTagName('input'),
      // это инпуты с определенной формы, которую я получил выше
  statusMessage = document.createElement('div'),
      // создал блок, куда помещу сообщения из объекта message
  errorMessage = document.createElement('div'),
      formContacts = document.getElementById('form'),
      inputContacts = formContacts.getElementsByTagName('input');
  statusMessage.classList.add('status');
  errorMessage.classList.add('status'); // formData.append('phone2', '+7(905) 397 74 21'); потренировался в использовании метода к форме
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              formData = new FormData(form); // formData.append('phone2', '+7(905) 397 74 21'); потренировался в использовании метода к форме
  ...
  formContacts.addEventListener('submit', /*#__PURE__*/function () {
    var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(event) {
      var formContactsData, obj, response, i;
        ...
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              ...
              event.preventDefault(); // так я отменил стандартное поведение браузера. т.е. он при отправке формы всегда перезагружается. даже с использование AJAX

              formContacts.appendChild(statusMessage);
              formContacts.appendChild(errorMessage);
              formContactsData = new FormData(formContacts);
              obj = {};
...
function modal() {
  ...
  more.addEventListener('click', function () {
    overlay.style.display = 'block'; // this.classList.add('more-splash');
...
function slider() {
  var slideIndex = 1,
      // параметр текущего слайда, т.е тот, который будет показываться
  ...
  function showSlides(n) {
    // эта функция показывает / скрывает слайды
    if (n > slides.length) {
      slideIndex = 1;
    }

    if (n == 0) {
      // или можно использовать if (n < 1)
  ...
  function plusSlides(n) {
    // эта функция переключает слайды, взаимодействуя с параметром slideIndex
...
function timer() {
  var deadline = '2021-12-31'; // конечная дата
  ...
  function getTimeRemaining(endTime) {
    ...
    seconds = Math.floor(t / 1000 % 60),
        ...
        days = Math.floor(t / (1000 * 60 * 60 * 24)); // чтобы получить дни: 
    // hours = Math.floor((t / (1000 * 60 * 60)) % 24),
  ...
  function setClock(endTime) {
    var timer = document.getElementById('timer'),
        // в видеоуроке он передаетсюда аргумент id, я убрал его и все работает
...
__webpack_require__(/*! nodelist-foreach-polyfill */ "./node_modules/nodelist-foreach-polyfill/index.js"); // полифил для forEach


__webpack_require__(/*! formdata-polyfill */ "./node_modules/formdata-polyfill/formdata.min.js"); // полифил для formData
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  var form = __webpack_require__(/*! ./parts/form.js */ "./src/js/parts/form.js"),
      calculate = __webpack_require__(/*! ./parts/calculate.js */ "./src/js/parts/calculate.js"),
